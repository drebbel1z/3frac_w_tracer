...
log_frac_aperature_1 = -3.42
log_frac_aperature_2 = -3.42
log_frac_aperature_3 = -3.42

frac_aperature_1 = ${fparse 10^log_frac_aperature_1}
frac_aperature_2 = ${fparse 10^log_frac_aperature_2}
frac_aperature_3 = ${fparse 10^log_frac_aperature_3}

log_frac_roughness = -2.084853632709371
frac_roughness = ${fparse 10^log_frac_roughness}
...
log_matrix_perm =-16.7521428526564
matrix_perm = ${fparse 10^log_matrix_perm} #1e-14 to 1e-16 you want good sample from log space

log_matrix_poro = -2.4941280070166947 #2.0e-4
matrix_poro = ${fparse 10^log_matrix_poro}
...
endTime = ${fparse 9*24*3600} # 10 days.  This is about 6 days after injection which seems fine
initial_dt = 100
dt_max = 50000
...
[BCs]
  ...
  [porepressure_outflow]
    ...
    flux_type = fluid
    variable = porepressure
    mass_fraction_component = 1 #porepressure is mass fraction variable 1; tracer is zero.
    save_in = porepressure_outflow
  []
  [temperature__outflow]
    type = PorousFlowOutflowBC
    boundary = 'xmin xmax ymin ymax'
    flux_type = heat
    variable = temperature
...
[Postprocessors]
  ...
  []
  [param_frac_aperature_1]
    type = Receiver
    default = '${frac_aperature_1}'
  []
  [param_frac_aperature_2]
    type = Receiver
    default = '${frac_aperature_2}'
  []
  [param_frac_aperature_3]
    type = Receiver
    default = '${frac_aperature_3}'
  []
